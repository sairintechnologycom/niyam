"""Sutra setup — interactive onboarding wizard."""
...
def run_setup(console: Console) -> None:
    ...
    console.print(
        Panel(
            "[bold magenta]Welcome to the Sutra Onboarding Wizard![/]\n"
            "This wizard will guide you through setting up your workspace config.",
            title="[bold magenta]Sutra Setup[/]",
    ...
    if not sutra_dir.exists():
        ...
        console.print("[green]✓ .sutra/ directory is already initialized.[/]")
    ...
    console.print("[green]✓ Guardrail settings updated in sutra.yaml[/]")
