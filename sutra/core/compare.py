"""Sutra multi-runtime task comparison logic."""
...
from sutra.core.config import find_sutra_root, get_sutra_dir, load_project_config
...
def run_comparison(task_id: str, executors_str: str, console: Console) -> None:
    ...
    for executor in executors:
        ...
        branch_name = f"sutra-compare-{mission_id}-{task['id']}-{executor}"
