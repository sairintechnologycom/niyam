"""Sutra mission dashboard — live-monitoring of active mission status, tasks, and token metrics."""
...
def run_mission_dashboard(watch: bool, console: Console) -> None:
    ...
    if watch:
        ...
        console.print(generate_dashboard_renderable(run_dir, sutra_dir, mission_id))
